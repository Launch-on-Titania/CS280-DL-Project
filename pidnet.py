...
class PIDNet(nn.Module):
    ...
    def __init__(self, m=2, n=3, num_classes=19, planes=64, ppm_planes=96, head_planes=128, augment=True):
        ...
        self.conv1 =  nn.Sequential(
                          ...
                          nn.Conv2d(planes, planes, kernel_size=3, stride=2, padding=1,groups=planes),
        ...
        self.compression3 = nn.Sequential(
                                          ...
                                          nn.Conv2d(planes*4,planes*4,kernel_size=1,bias=False,groups=planes*4),
        ...
        self.compression4 = nn.Sequential(
                                          ...
                                          nn.Conv2d(planes * 8, planes * 8, kernel_size=1, bias=False, groups=planes * 8),
                                          nn.Conv2d(planes * 8, planes * 2, kernel_size=1),
                                          BatchNorm2d(planes * 2, momentum=bn_mom),
                                          )
        ...
        if m == 2:
            ...
            self.diff3 = nn.Sequential(
                                        ...
                                        nn.Conv2d(planes * 4,planes * 4,kernel_size=3,padding=1,groups = planes * 4),
    ...
    def _make_layer(self, block, inplanes, planes, blocks, stride=1):
        ...
        if stride != 1 or inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                nn.Conv2d(inplanes,inplanes,kernel_size=1,stride=stride,bias=False,groups=inplanes),
